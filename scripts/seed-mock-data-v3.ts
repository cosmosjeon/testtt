...
async function seedMockDataV3() {
  console.log("🌱 목 데이터 V3 생성 시작...")
  console.log("✨ 기깔나는 설명과 함께!")
  ...
  try {
    ...
    console.log(`   - 프로젝트: ${insertedProjects.length}개 (✨ 업그레이드된 설명)`)
